...
<body>
	...
	<div class="container">
			...
			<c:when test="${searchList.pageList.size() eq 0}">
				<div class="row justify-content-center">
					<div
						...
						<span class="subheading">Your on-sale List</span>
						<h2 class="mb-2">This is the list of books</h2>
					</div>
				</div>
				<h5 class="row justify-content-center">작성한 글이 없습니다.</h5>
			</c:when>
		...
		<div class="row">
			<c:forEach var="book" items="${searchList.pageList}"
				varStatus="status">
				<div class="col-md-4">
					<div class="property-wrap ftco-animate">
						...
						<div class="text">
							<table style="font-size: 14px">
								...
								<tr>
									<td>책 상태</td>
									<td style="padding-left: 20px">${book.book.condition}</td>
								</tr>
								<tr>
									<td>정가</td>
									<td style="padding-left: 20px"><fmt:formatNumber
											value="${book.book.price}" pattern="#,###" />원</td>
								</tr>
								<tr>
									<td>거래종류</td>
