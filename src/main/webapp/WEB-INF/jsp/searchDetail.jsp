	    ...
	    <div class="container">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav ml-auto">
	          ...
	          <li class="nav-item active"><a class="nav-link" href="<c:url value="/search.do" />">검색</a></li>
	          <c:if test="${!empty userSession.user}">
	    	...
	    	<div class="row">
					<div class="col-md-12">
						<div class="search-wrap-1 ftco-animate">
							<form action='<c:url value="/search/detail.do"/>' method="POST" class="search-property-1">
		        		<div class="row">
		        			<div class="col-lg align-items-end">
		        				<div class="form-group">
		        					<label for="#" style="margin-left:220px">키워드 검색하세요.</label>
		          				<div class="form-field">
		          					<div class="icon"><span class="ion-ios-search"></span></div>
				                <input type="text" name="keyword" class="form-control" placeholder="키워드" style="margin-left:200px" value="${keyword}">
				                ...
				                <input type="text" name="lowPrice" class="form-control" placeholder="0" style="margin-left:200px" value="${lowPrice}">~<input type="text" name="highPrice" class="form-control" placeholder="999,999,999" style="margin-left:200px" value="${highPrice}">
				              </div>
			              </div>
		        			</div>
