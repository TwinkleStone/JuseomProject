				...
				<form:form modelAttribute="userForm" method="post"
					...
					<table class="table table-hover" style="text-align: center">
						...
						<tr>
							<td>주소 1</td>
							<td>
							<form:input path="user.address1" size="11"/>
							<form:errors path="user.address1" /> 시/도 &nbsp; &nbsp;  &nbsp; 
							</td>
						</tr>
						<tr>
							<td>주소 2</td>
							<td>
							<form:input path="user.address2" size="11" />
							<form:errors path="user.address2" /> 시/군/구
							</td>
						</tr>
						<tr>
							<td>주소 3</td>
							<td>
							<form:input path="user.address3" size="11" />
							<form:errors path="user.address3" /> 동/읍/면
							</td>
						</tr>
						<tr>
							<td>닉네임</td>
							<td><form:input path="user.commName" /> <form:errors
