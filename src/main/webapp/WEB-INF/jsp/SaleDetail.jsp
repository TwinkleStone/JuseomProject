          ...
          <div class="col-md-12 ftco-animate" style="align: center">
            ...
            <div class="row justify-content-center">
          		...
          		<table style="background: #f8f9fa">
	        		<tr>
	        			<td style="padding-left: 20px; text-align: center"> <img src="${sale.book.imageUrl}" alt="Image placeholder" class="img-fluid mb-4"></td>
	        			<td style="padding: 30px; width: 500px">
	        				<div class="desc">
				                <h4>${sale.book.name}</h4>
				                <p>${sale.book.author}(지은이) | ${sale.book.publisher} | <fmt:parseDate value="${sale.book.date}" pattern="yyyyMMdd" var="parseDate"/><fmt:formatDate value="${parseDate}" pattern="yyyy년MM월dd일" /></p>
				              	<p><span style="text-decoration: line-through;"><fmt:formatNumber value="${sale.book.price}" pattern="#,###"/></span>&nbsp;&nbsp;<span style="font-size: 20px; color: #d4ca68"><fmt:formatNumber value="${sale.suggestPrice}" pattern="#,###"/>원</span></p>
				              	<p>상태 : <span style="text-weight: bold; color: #d4ca68">${sale.book.condition}</span></p>
	              			</div>
	              		</td>
	        		</tr>
	        		<tr>
				...
				<table>
	        		<tr style="text-align: center">
	        			<td width="50%" style="padding: 30px">
	        				<div class="form-group">
                    			<input type="button" value="구매 신청" class="btn py-3 px-4 btn-primary">
                  			</div>
	 					</td>
	 					<td width="50%" style="padding: 30px">
	        				<div class="form-group">
