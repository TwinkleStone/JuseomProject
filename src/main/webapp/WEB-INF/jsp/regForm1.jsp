	...
	<div class="container">
		<div class="row justify-content-center">
			<div class="col-md-12 heading-section text-center ftco-animate mb-5">
				<h2 class="mb-2">Register - STEP1</h2>
				<br />
				...
				<form:form modelAttribute="userForm" method="post" action="/juseom/user/register/step2.do">
					<table class="table" style="text-align: center">
						...
						<tr>
							<td><form:errors path="user.userId" /> <br /></td>
						</tr>
						<tr>
							<td rowspan="2"><label for="password">암호</label>:</td>
							<td><form:password path="user.password" /></td>
						</tr>
						<tr>
							<td><form:errors path="user.password" /> <br /></td>
						</tr>
						<tr>
							<td rowspan="2"><label for="confirmPassword">암호 확인</label>:</td>
							<td><form:password path="confirmPassword" /></td>
						</tr>
						<tr>
							<td><form:errors path="confirmPassword" /> <br /></td>
						</tr>
						<tr>
							<td rowspan="2"><label for="name">이름</label>:</td>
							<td><form:input path="user.name" /></td>
						</tr>
						<tr>
							<td><form:errors path="user.name" /> <br /></td>
						</tr>
						<tr>
							<td rowspan="2"><label for="phone">전화번호</label>:</td>
							<td><form:input path="user.phone" /></td>
						</tr>
						<tr>
							<td><form:errors path="user.phone" /> <br /></td>
						</tr>
						<tr>
							<td rowspan="2">주소 1</td>
							<td><form:input path="user.address1" size="11" />
							시/도 &nbsp; &nbsp;&nbsp;</td>
						</tr>
						<tr>
							<td><form:errors path="user.address1" /> <br /></td>
						</tr>
						<tr>
							<td rowspan="2">주소 2</td>
							<td><form:input path="user.address2" size="11" />
							시/군/구 &nbsp; &nbsp;&nbsp;</td>
						</tr>
						<tr>
							<td><form:errors path="user.address2" /> <br /></td>
						</tr>
						<tr>
							<td rowspan="2">주소 3</td>
							<td><form:input path="user.address3" size="11" />
							동/읍/면</td>
						</tr>
						<tr>
